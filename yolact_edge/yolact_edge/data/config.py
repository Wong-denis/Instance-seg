...
IR_hand_dataset = dataset_base.copy({
    'name': 'IR hand dataset',
    
    'train_images': './yolact_edge/data/IR_hand/',
    
    'train_info': './yolact_edge/data/IR_hand/annotations.json',
    
    'valid_images': './yolact_edge/data/IR_hand/',
    
    'valid_info': './yolact_edge/data/IR_hand/annotations.json',
...
hand_doll_dataset = dataset_base.copy({
    'name': 'hand doll dataset',
    
    'train_images': './yolact_edge/data/hand_doll/',
    
    'train_info': './yolact_edge/data/hand_doll/annotations.json',
    
    'valid_images': './yolact_edge/data/hand_doll/',
    
    'valid_info': './yolact_edge/data/hand_doll/annotations.json',
    
    'has_gt': True,
    
    'class_names': ('doll','hand'),
    
    'label_map': {1:1,2:2}
})

stick_dataset = dataset_base.copy({
    'name': 'stick dataset',
    
    'train_images': './yolact_edge/data/stick_train2/',
    
    'train_info': './yolact_edge/data/stick_train2/annotations.json',
    
    'valid_images': './yolact_edge/data/stick_val2/',
    
    'valid_info': './yolact_edge/data/stick_val2/annotations.json',
...
wire_dataset = dataset_base.copy({
    'name': 'wire dataset',
    
    'train_images': './yolact_edge/data/wire3_train/',
    
    'train_info': './yolact_edge/data/wire3_train/annotations.json',
    
    'valid_images': './yolact_edge/data/wire3_val/',
    
    'valid_info': './yolact_edge/data/wire3_val/annotations.json',
...
cable_dataset = dataset_base.copy({
    'name': 'cable dataset',
    
    'train_images': './yolact_edge/data/cable3_train/',
    
    'train_info': './yolact_edge/data/cable3_train/annotations.json',
    
    'valid_images': './yolact_edge/data/cable3_val/',
    
    'valid_info': './yolact_edge/data/cable3_val/annotations.json',
...
yolact_edge_resnet50_hand_doll_config = yolact_edge_config.copy({
    'name': 'yolact_edge_resnet50_hand_doll',
    
    'torch2trt_max_calibration_images': 100,
    'dataset': hand_doll_dataset,
    'num_classes': 3,
    'max_size': 550,
    'lr_steps': (2800, 6000, 7000, 7500),
    'max_iter': 2000,
...
yolact_edge_resnet50_stick_config = yolact_edge_resnet50_config.copy({
    'name': 'yolact_edge_resnet50_stick',

    'dataset': stick_dataset,
    'num_classes': 2,
    'max_iter': 2000,
...
yolact_edge_resnet50_wire_config = yolact_edge_resnet50_config.copy({
    'name': 'yolact_edge_resnet50_wire',

    'dataset': wire_dataset,
    'num_classes': 2,
    'max_iter': 8000,
    # 'max_size': 700,
...
yolact_edge_resnet50_cable_config = yolact_edge_resnet50_config.copy({
    'name': 'yolact_edge_resnet50_cable',

    'dataset': cable_dataset,
    'num_classes': 2,
    'max_iter': 4000,
    'max_size': 550,
