...
hand_dataset = dataset_base.copy({
    'name': 'IR hand Dataset',
    'train_images': './data/flir_hands/',
    'train_info': './data/flir_hands/annotations.json',
    'valid_images': './data/flir_hands/',
    'valid_info': './data/flir_hands/annotations.json',
    'has_gt': True,
    'class_names': ('hand'),
    'label_map': {1:1}
})
...
wire_dataset = dataset_base.copy({
    ...
    'train_images': './data/wire_train2/',
    
    'train_info': './data/wire_train2/annotations.json',
    
    'valid_images': './data/wire_val2/',
    
    'valid_info': './data/wire_val2/annotations.json',
...
cable_dataset = dataset_base.copy({
    ...
    'train_images': './data/cable3_train/',
    
    'train_info': './data/cable3_train/annotations.json',
    
    'valid_images': './data/cable3_val/',
    
    'valid_info': './data/cable3_val/annotations.json',
...
yolact_resnet50_hand_config = yolact_resnet50_config.copy({
    'name': 'yolact_resnet50_hands',
    'dataset': hand_dataset,
    'num_classes': 2,
})

yolact_resnet50_wire_config = yolact_resnet50_config.copy({
    'name': 'yolact_resnet50_wire',
...
yolact_resnet50_cable_config = yolact_resnet50_config.copy({
    'name': 'yolact_resnet50_cable',
